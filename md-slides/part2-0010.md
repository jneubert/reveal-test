...
Internal data model and storage is transformed to RDF in
- RDF dumps
...
Output has full URLs to external resources, _however_ with Wikidata-specific properties:

```
  wd:Q123 wdt:P234 "External-ID" ;
          wdtn:P234 <http://example.com/reference/External-ID>
```
Even [exact match] is not translated to skos:exactMatch.
